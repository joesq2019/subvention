...
<div class="modal fade" id="modalChangeStatus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            	<div class="col-md-6">
            		<h5 class="modal-title" id="exampleModalLabel">Cambiar Estado de la subvención</h5>
            	</div>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body">
            	<input type="hidden" name="id_subvention_status" id="id_subvention_status">
            	<form id="formChangeStatus">
					<div class="col-md-12">
						<div class="form-group m-form__group">
							<label for="">Estado</label>
		        			<select name="select_change_status" id="select_change_status" class="form-control">
		        				<option value="">Selecciona una opción</option>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary tr" key="" data-dismiss="modal">Cerrar</button>
                <button type="button" class="btn btn-success" id="btnSaveChangeStatus">Guardar</button>
            </div>
        </div>
    </div>
</div>
